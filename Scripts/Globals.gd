...
const tree = preload("res://Assets/Obstacles/Big-Tree.png")
...
const dark_tree = preload("res://Assets/Obstacles/DarkTree.png")
...
const themes = {
	...
	preload("res://Assets/Backgrounds/ForestBackground4.png")],
		...
		"obstacles-low": [green_flatstone, stump, bush, green_hill],
		"obstacles-offset": 5,
		"obstacles-high": {
			"textures": [green_wall, tree, green_wall2],
			"positions": [Vector2(0, -165), Vector2(-24, -160), Vector2(-0, -175)],
	...
	1: {
		...
		"obstacles-high": {
			...
			"positions": [Vector2(0, -170), Vector2(0, -200), Vector2(4, -150)],
	...
	2: {
		...
		"obstacles-offset": 0,
		"obstacles-high": {
			"textures": [village_wall, tree, village_wall2],
			"positions": [Vector2(0, -160), Vector2(-24, -160), Vector2(0, -150)],
			"scale": [Vector2(1, 1), Vector2(1, 1), Vector2(1, 1)]
		}
	},
	...
	3: {
		...
		"obstacles-offset": 5,
		"obstacles-high": {
			"textures": [dark_wall, dark_tree],
			"positions": [Vector2(0, -170), Vector2(-8, -218)],
			"scale": [Vector2(1, 1), Vector2(0.6, 0.6)]
		}
	},
	...
	4: {
		...
		"obstacles-offset": 0,
		"obstacles-high": {
			"textures": [dark_forest_wall, dark_tree],
			"positions": [Vector2(0, -155), Vector2(-8, -218)],
			"scale": [Vector2(1, 1), Vector2(0.6, 0.6)]
		}
	}
}
